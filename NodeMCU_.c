...
const unsigned long sending_interval = 60000; //1分钟传递一次数据
...
//      { Serial.println("Gprs valid");
 ...
 //拼接aprs数据格式          
           String Aprs_string="BG4WLG-1>ES66:="+str_lat+"/"+str_lng+"="+"000/000g000t"+Aprs_Temperature+"r000p000h"+Aprs_Humidty+"b"+Aprs_Pressure+"温度:"+bme280.readTemperature()+"°C"+" 湿度:"+bme280.readHumidity()+"%"+" 大气压:"+bme280.readPressure()/100+"mpar"+"\r\n"+"\r\n";
